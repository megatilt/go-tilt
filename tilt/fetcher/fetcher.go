...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (tilt/61) or header (tilt/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (tilt/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both tilt/61 and tilt/62)
}
