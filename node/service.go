...
func (ctx *ServiceContext) OpenDatabase(name string, cache int, handles int) (tiltdb.Database, error) {
	if ctx.config.DataDir == "" {
		return tiltdb.NewMemDatabase()
	}
	return tiltdb.NewLDBDatabase(ctx.config.resolvePath(name), cache, handles)
}
