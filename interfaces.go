...
// Package tiltnet defines interfaces for interacting with Tiltnet.
package tiltnet
...
type CallMsg struct {
	...
	GasPrice *big.Int        // dwan <-> gas exchange ratio
	Value    *big.Int        // amount of dwan sent along with the call
	Data     []byte          // input data, usually an ABI-encoded contract method invocation
}

// A ContractCaller provides contract calls, essentially transactions that are executed by
// the TiltVM but not mined into the blockchain. ContractCall is a low-level method to
