...
// NewTiltVMContext creates a new context for use in the TiltVM.
func NewTiltVMContext(msg Message, header *types.Header, chain ChainContext, author *common.Address) vm.Context {
