...
// stateObject represents an Tiltnet account which is being modified.
//
...
type stateObject struct {
	address common.Address // Tiltnet address of this account
	data    Account
	db      *StateDB
...
// Account is the Tiltnet consensus representation of accounts.
