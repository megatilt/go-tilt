...
// Package accounts implements high level Tiltnet account management.
package accounts
...
// Account represents an Tiltnet account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Tiltnet account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain tiltnet.ChainStateReader)
