...
// cacheSize calculates and returns the size of the tilthash verification cache that
...
// datasetSize calculates and returns the size of the tilthash mining dataset that
