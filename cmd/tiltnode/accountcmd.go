...
var (
	walletCommand = cli.Command{
		Name:     "wallet",
		Usage:    "Import Tiltnet presale wallets",
		...
		Description: `
		    tiltnode wallet [options] /path/to/my/presale.wallet
...
between tiltnet nodes by simply copying.
...
`,
			},
			{
				...
				Description: `
    tiltnode account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    tiltnode account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    tiltnode account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    tiltnode account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another tiltnet instance,
