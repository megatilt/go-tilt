...
/*
Package vm implements the Tiltnet Virtual Machine.

The vm package implements two TiltVMs, a byte code VM and a JIT VM. The BC
(Byte Code) VM loops over a set of bytes and executes them according to the set
of rules defined in the Tiltnet yellow paper. When the BC VM is invoked it
