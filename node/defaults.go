...
var DefaultConfig = Config{
	...
	HTTPModules: []string{"net", "quads"},
	WSPort:      DefaultWSPort,
	WSModules:   []string{"net", "quads"},
	P2P: p2p.Config{
		ListenAddr: ":20202",
		MaxPeers:   25,
		NAT:        nat.Any(),
...
func DefaultDataDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home, "Library", "Tiltnet")
		} else if runtime.GOOS == "windows" {
			return filepath.Join(home, "AppData", "Roaming", "Tiltnet")
		} else {
			return filepath.Join(home, ".tiltnet")
		}
	}
