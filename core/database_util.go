...
var (
	...
	configPrefix = []byte("tiltnet-config-") // config prefix for the db
...
func GetCanonicalHash(db tiltdb.Database, number uint64) common.Hash {
...
func GetBlockNumber(db tiltdb.Database, hash common.Hash) uint64 {
...
func GetHeadHeaderHash(db tiltdb.Database) common.Hash {
...
func GetHeadBlockHash(db tiltdb.Database) common.Hash {
...
func GetHeadFastBlockHash(db tiltdb.Database) common.Hash {
...
func GetHeaderRLP(db tiltdb.Database, hash common.Hash, number uint64) rlp.RawValue {
...
// found.
func GetHeader(db tiltdb.Database, hash common.Hash, number uint64) *types.Header {
...
func GetBodyRLP(db tiltdb.Database, hash common.Hash, number uint64) rlp.RawValue {
...
func GetBody(db tiltdb.Database, hash common.Hash, number uint64) *types.Body {
...
// none found.
func GetTd(db tiltdb.Database, hash common.Hash, number uint64) *big.Int {
...
func GetBlock(db tiltdb.Database, hash common.Hash, number uint64) *types.Block {
...
func GetBlockReceipts(db tiltdb.Database, hash common.Hash, number uint64) types.Receipts {
...
func GetTransaction(db tiltdb.Database, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
func GetReceipt(db tiltdb.Database, hash common.Hash) *types.Receipt {
...
func WriteCanonicalHash(db tiltdb.Database, hash common.Hash, number uint64) error {
...
func WriteHeadHeaderHash(db tiltdb.Database, hash common.Hash) error {
...
func WriteHeadBlockHash(db tiltdb.Database, hash common.Hash) error {
...
func WriteHeadFastBlockHash(db tiltdb.Database, hash common.Hash) error {
...
func WriteHeader(db tiltdb.Database, header *types.Header) error {
...
func WriteBody(db tiltdb.Database, hash common.Hash, number uint64, body *types.Body) error {
...
func WriteBodyRLP(db tiltdb.Database, hash common.Hash, number uint64, rlp rlp.RawValue) error {
...
func WriteTd(db tiltdb.Database, hash common.Hash, number uint64, td *big.Int) error {
...
func WriteBlock(db tiltdb.Database, block *types.Block) error {
...
func WriteBlockReceipts(db tiltdb.Database, hash common.Hash, number uint64, receipts types.Receipts) error {
...
func WriteTransactions(db tiltdb.Database, block *types.Block) error {
	batch := db.NewBatch()
...
func WriteReceipt(db tiltdb.Database, receipt *types.Receipt) error {
...
func WriteReceipts(db tiltdb.Database, receipts types.Receipts) error {
	batch := db.NewBatch()
...
func DeleteCanonicalHash(db tiltdb.Database, number uint64) {
	db.Delete(append(append(headerPrefix, encodeBlockNumber(number)...), numSuffix...))
}

// DeleteHeader removes all block header data associated with a hash.
func DeleteHeader(db tiltdb.Database, hash common.Hash, number uint64) {
	db.Delete(append(blockHashPrefix, hash.Bytes()...))
	db.Delete(append(append(headerPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteBody removes all block body data associated with a hash.
func DeleteBody(db tiltdb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(bodyPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteTd removes all block total difficulty data associated with a hash.
func DeleteTd(db tiltdb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(append(headerPrefix, encodeBlockNumber(number)...), hash.Bytes()...), tdSuffix...))
}

// DeleteBlock removes all block data associated with a hash.
func DeleteBlock(db tiltdb.Database, hash common.Hash, number uint64) {
...
func DeleteBlockReceipts(db tiltdb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(blockReceiptsPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteTransaction removes all transaction data associated with a hash.
func DeleteTransaction(db tiltdb.Database, hash common.Hash) {
...
func DeleteReceipt(db tiltdb.Database, hash common.Hash) {
...
// MIP bloom bin.
func WriteMipmapBloom(db tiltdb.Database, number uint64, receipts types.Receipts) error {
	mipmapBloomMu.Lock()
...
func GetMipmapBloom(db tiltdb.Database, number, level uint64) types.Bloom {
	bloomDat, _ := db.Get(mipmapKey(number, level))
	return types.BytesToBloom(bloomDat)
}

// PreimageTable returns a Database instance with the key prefix for preimage entries.
func PreimageTable(db tiltdb.Database) tiltdb.Database {
	return tiltdb.NewTable(db, preimagePrefix)
}

// WritePreimages writes the provided set of preimages to the database. `number` is the
// current block number, and is used for debug messages only.
func WritePreimages(db tiltdb.Database, number uint64, preimages map[common.Hash][]byte) error {
...
func GetBlockChainVersion(db tiltdb.Database) int {
	var vsn uint
...
func WriteBlockChainVersion(db tiltdb.Database, vsn int) {
	enc, _ := rlp.EncodeToBytes(uint(vsn))
	db.Put([]byte("BlockchainVersion"), enc)
}

// WriteChainConfig writes the chain config settings to the database.
func WriteChainConfig(db tiltdb.Database, hash common.Hash, cfg *params.ChainConfig) error {
...
func GetChainConfig(db tiltdb.Database, hash common.Hash) (*params.ChainConfig, error) {
...
func FindCommonAncestor(db tiltdb.Database, a, b *types.Header) *types.Header {
