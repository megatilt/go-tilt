...
//
// Account references are used during TiltVM initialisation and
...
// Contract represents an tiltnet contract in the state database. It contains
...
// NewContract returns a new contract environment for the execution of TiltVM.
