...
// Syncing provides information when this nodes starts synchronising with the Tiltnet network and when it's finished.
...
type SyncingResult struct {
	...
	Status  tiltnet.SyncProgress `json:"status"`
}
