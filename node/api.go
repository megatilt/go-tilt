...
// PublicQuadsAPI offers helper utils
type PublicQuadsAPI struct {
	stack *Node
}

// NewPublicQuadsAPI creates a new QuadsService instance
func NewPublicQuadsAPI(stack *Node) *PublicQuadsAPI {
	return &PublicQuadsAPI{stack}
}

// ClientVersion returns the node name
func (s *PublicQuadsAPI) ClientVersion() string {
	return s.stack.Server().Name
}

// Sha3 applies the tiltnet sha3 implementation on the input.
// It assumes the input is hex encoded.
func (s *PublicQuadsAPI) Sha3(input hexutil.Bytes) hexutil.Bytes {
