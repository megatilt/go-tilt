...
import (
	...
	"github.com/megatilt/go-tilt/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Tiltnet contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Tiltnet contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Tiltnet contract Solidity source to build and bind")
