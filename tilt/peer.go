...
// PeerInfo represents a short summary of the Tiltnet sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Tiltnet protocol version negotiated
...
// Handshake executes the tilt protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("tilt/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Tiltnet sub-protocol.
type peerSet struct {
