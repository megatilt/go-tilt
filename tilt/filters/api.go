...
// information related to the Tiltnet protocol such als blocks, transactions and logs.
...
// `tilt_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/tiltnet/wiki/wiki/JSON-RPC#tilt_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with tilt_getFilterChanges.
//
// https://github.com/tiltnet/wiki/wiki/JSON-RPC#tilt_newblockfilter
...
//
// https://github.com/tiltnet/wiki/wiki/JSON-RPC#tilt_newfilter
...
//
// https://github.com/tiltnet/wiki/wiki/JSON-RPC#tilt_getlogs
...
//
// https://github.com/tiltnet/wiki/wiki/JSON-RPC#tilt_uninstallfilter
...
//
// https://github.com/tiltnet/wiki/wiki/JSON-RPC#tilt_getfilterlogs
...
//
// https://github.com/tiltnet/wiki/wiki/JSON-RPC#tilt_getfilterchanges
