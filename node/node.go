...
func New(conf *Config) (*Node, error) {
	...
	// We rely on this in cmd/tiltnode.
...
func (n *Node) OpenDatabase(name string, cache, handles int) (tiltdb.Database, error) {
	if n.config.DataDir == "" {
		return tiltdb.NewMemDatabase()
	}
	return tiltdb.NewLDBDatabase(n.config.resolvePath(name), cache, handles)
}
