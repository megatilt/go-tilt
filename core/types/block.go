...
// Package types contains data types related to Tiltnet consensus.
package types
...
import (
	...
	"github.com/megatilt/go-tilt/crypto/sha3"
...
// Header represents a block header in the Tiltnet blockchain.
type Header struct {
...
// Block represents an entire block in the Tiltnet blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package tilt to track
...
// [deprecated by tilt/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for tilt protocol, etc.
...
// EncodeRLP serializes b into the Tiltnet RLP block format.
