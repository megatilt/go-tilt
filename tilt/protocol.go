...
var ProtocolName = "tilt"

// Supported versions of the tilt protocol (first is primary).
...
// tilt protocol message codes
const (
	// Protocol messages belonging to tilt/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to tilt/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
