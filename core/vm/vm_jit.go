...
void* tiltvmjit_create();
int   tiltvmjit_run(void* _jit, void* _data, void* _env);
void  tiltvmjit_destroy(void* _jit);

// Shared library tiltvmjit (e.g. libtiltvmjit.so) is expected to be installed in /usr/local/lib
// More: https://github.com/tiltnet/tiltvmjit
#cgo LDFLAGS: -ltiltvmjit
*/
import "C"
...
func NewJitVm(env TiltVM) *JitVm {
...
func (self *JitVm) Run(me, caller ContextRef, code []byte, value, gas, price *big.Int, callData []byte) (ret []byte, err error) {
	...
	jit := C.tiltvmjit_create()
	retCode := C.tiltvmjit_run(jit, unsafe.Pointer(&self.data), unsafe.Pointer(self))
