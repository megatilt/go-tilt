...
/*
Package node sets up multi-protocol Tiltnet nodes.
...
endpoint to a subset of RPC modules. Node itself offers the "debug", "admin" and "quads"
modules.
...
Node also creates the shared store of encrypted Tiltnet account keys. Services can access
