...
func SetupGenesisBlock(db tiltdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) Commit(db tiltdb.Database) (*types.Block, error) {
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db tiltdb.Database) *types.Block {
...
// GenesisBlockForTesting creates and writes a block in which addr has the given dwan balance.
func GenesisBlockForTesting(db tiltdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Tiltnet main net genesis block.
...
// DevGenesisBlock returns the 'tiltnode --dev' genesis block.
